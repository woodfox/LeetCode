...
class RemoveDuplicateInSortedListTest extends FunSuite with ListHelper with ShouldMatchers {
  val r = new RemoveDuplicateInSortedList

  test("should work") {
    val actual = r.deleteDuplicates(createList(List(1,1,1,2,2,2,3,3,3)))
    compareList(actual, createList(List(1,2,3))) should be(true)

    val actual2 = r.deleteDuplicates(createList(List(1,1,1,2,2,2,3)))
    compareList(actual2, createList(List(1,2,3))) should be(true)
    ...
    compareList(actual4, createList(List(1,2,3))) should be(true)

    val actual5 = r.deleteDuplicates(createList(List(1)))
    compareList(actual5, createList(List(1))) should be(true)

    val actual6 = r.deleteDuplicates(createList(List(1,2,3,4,5,6,6,6,6)))
